...
export default function ArchiveOverview({ trip, onTripUpdated }) {
  ...
  return (
    <>
          ...
          <section className="info-block archive-timeline-block">
            ...
            {!imports.length ? (
              ...
              <>
                ...
                <button className="timeline-schedule-import-button" onClick={() => setScheduleImportOpen(true)}>
      ...
      {scheduleImportOpen && <TimelineScheduleImportSheet trip={trip} onClose={() => setScheduleImportOpen(false)} onImported={async () => { setScheduleImportOpen(false); await load() }} />}
    </>
  )
}
