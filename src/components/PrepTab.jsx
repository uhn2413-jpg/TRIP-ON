...
function PrepItemModal({ initial, tripId, onClose, onSaved }) {
  ...
  return (
    <div className="modal-backdrop">
      <div className="create-sheet compact-sheet">
        <div className="sheet-handle" />
        <div className="sheet-head"><button onClick={onClose}>취소</button><span>{type === 'packing' ? '준비물' : '할 일'} {initial.id ? '수정' : '추가'}</span><div /></div>
...
function ReservationModal({ initial, trip, itinerary, onClose, onSaved, onMessage }) {
  ...
  return (
    <div className="modal-backdrop">
      <div className="create-sheet reservation-sheet">
        <div className="sheet-handle" />
        <div className="sheet-head"><button onClick={onClose}>취소</button><span>{editing ? '예약 수정' : '예약 추가'}</span><div /></div>
        <div className="sheet-body tidy-form">
...
function TripInfoModal({ initial, tripId, onClose, onSaved }) {
  ...
  return (
    <div className="modal-backdrop">
      <div className="create-sheet compact-sheet">
        <div className="sheet-handle" />
        <div className="sheet-head"><button onClick={onClose}>취소</button><span>여행 정보 {initial.id ? '수정' : '추가'}</span><div /></div>
        <div className="sheet-body tidy-form">
