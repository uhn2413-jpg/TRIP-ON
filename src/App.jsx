          ...
          <section className="cover-photo-section">
            ...
            <div className="cover-photo-actions">
              <label className={`cover-photo-picker ${photoWorking ? 'disabled' : ''}`}>
                ...
                <input type="file" accept="image/*" disabled={photoWorking} onChange={(e) => { const file = e.target.files?.[0]; e.target.value = ''; uploadPhoto(file) }} />
              </label>
            ...
            <small className="cover-photo-note">사진은 선택하면 바로 저장돼요. 12MB 이하 이미지만 사용할 수 있어요.</small>
