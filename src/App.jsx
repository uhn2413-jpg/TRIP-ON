...
import { AllTripsMap, DayMapSheet, TripMapSheet } from './components/TravelMap'
        ...
        <div className="sheet-body">
          ...
          {item.trip_on_places && (
            <div className="itinerary-place-detail">
              ...
              {item.trip_on_places.latitude != null && item.trip_on_places.longitude != null && <button onClick={() => window.open(googleMapsSearchUrl(placeFromRow(item.trip_on_places)), '_blank', 'noopener,noreferrer')}>지도에서 보기</button>}
            </div>
          )}
